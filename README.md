...
Download `DeskMesh-0.1.0-alpha.3-win-x64.zip` and `SHA256SUMS.txt` from [GitHub Releases](https://github.com/bz1121/DeskMesh/releases). Both PCs must run the same version.
